...
// include_once '/Sdp/app/controller/LoginController.php';
...
<head>
    ...
    <title>Login</title>
    <link rel="stylesheet" href="/Sdp/app/assets/css/login.css">
    <link rel="stylesheet" href="/Sdp/app/assets/css/global.css">
        ...
        <section id="content_form-login">
            <article id="content_figure_login">
                <figure id="figure_login">
                    <img src="/Sdp/app/assets/img/logoOficial.png" alt="Logo Centro De Formación Integral Providencia." id="img_login">
                </figure>
            </article>
            <h2 id="text_login">Inicia sesión</h2>
            <form id="form-login" method="POST" action="/../Sdp/app/controller/loginController.php">
